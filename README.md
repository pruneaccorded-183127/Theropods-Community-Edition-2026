...
# 🎮 Theropods — Community Edition

**Prehistoric puzzle-adventure in a self-contained standalone package.**
...
Theropods is an action-adventure puzzle platformer set in a prehistoric world, where a lone caveman must outwit and outrun deadly dinosaurs across hand-drawn environments. This Community Edition is a self-contained standalone build of the game, packaged for offline use. It includes all content of the original release and is ready to play immediately, with no additional software required.

For players who want a standalone, offline Community Edition of Theropods that runs immediately on any modern Windows PC.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1091870/ac0a81061deff8f8a60941f1a011f835de6d4b85/ss_ac0a81061deff8f8a60941f1a011f835de6d4b85.1920x1080.jpg?t=1788350291" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1091870/ss_a0f614d7e06aa314efccbfcdb446ca6e5d137fca.1920x1080.jpg?t=1788350291" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1091870/c55e33f03e1d3d932c4ea54bde6509baec79d291/ss_c55e33f03e1d3d932c4ea54bde6509baec79d291.1920x1080.jpg?t=1788350291" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
| **Compatibility** | Windows 10/11 (also runs on Windows 7/8 64-bit) |
...
- 🦖 **Dinosaur Encounters** — Evade theropods and other prehistoric predators through tense stealth sequences.
- 🧩 **Environmental Puzzles** — Use terrain, tools and timing to solve physics-based platforming challenges.
- 🎨 **Hand-Drawn Art Style** — Distinctive illustrated visuals bring the prehistoric world to life.
- 📦 **Self-Contained Package** — All game content included in a single independent release.
- 🔌 **Offline Play** — Runs fully offline as a standalone build with no storefront required.
- 🖥️ **Lightweight Requirements** — Runs smoothly on modest Windows hardware.
...
| **Processor** | Intel Core 2 Duo 2.0 GHz or equivalent | Intel Core i3 2.4 GHz or better |
| **RAM** | 2 GB | 4 GB |
| **Graphics** | DirectX 9.0c compatible, 512 MB VRAM | DirectX 11 compatible, 1 GB VRAM |
| **Storage** | 1 GB available space | 2 GB available space |
| **Additional** | DirectX 9.0c | DirectX 11 |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Theropods\Saved`
